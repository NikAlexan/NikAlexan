...
- [x] Найти блок терминала (case study / кодовый блок) и проверить фон/прозрачность на светлой теме.
- [x] Добавить отдельный фон для светлой темы (или увеличить непрозрачность).
- [x] Проверить читаемость текста и кода.
...
- [x] Найти источник маскота (SVG/PNG) и проверить как задается цвет.
- [x] Добавить вариант для светлой темы (бронза), для темной — оранжевый.
- [x] Проверить переключение темы на всех страницах.
